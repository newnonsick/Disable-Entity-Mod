...
public final class DisableEntityConfigScreenFactory {
        ...
        public static Screen create(Screen parent) {
                ...
                AtomicReference<OptimizationPreset> selectedPreset = new AtomicReference<>(initialPreset);
                ...
                ConfigCategory generalCategory = builder
                                .getOrCreateCategory(Text.translatable("text.disable_entity.category.general"));
                addDescription(generalCategory, entryBuilder, "text.disable_entity.overview.description");
                generalCategory.addEntry(entryBuilder
                                .startEnumSelector(Text.translatable("text.disable_entity.option.preset"),
                                                OptimizationPreset.class, config.activePreset)
                                .setDefaultValue(OptimizationPreset.CUSTOM)
                                .setEnumNameProvider(value -> presetLabel((OptimizationPreset) value))
                                .setSaveConsumer(selectedPreset::set)
                                .setTooltip(Text.translatable("text.disable_entity.tooltip.preset"))
                                .build());
                generalCategory.addEntry(entryBuilder.startTextDescription(buildFeatureSummary(config)).build());
                generalCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.global_enabled"), config.globalEnabled,
                                value -> config.globalEnabled = value, "text.disable_entity.tooltip.global_enabled"));
                generalCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.disable_entity_shadows"),
                                config.disableEntityShadows,
                                value -> config.disableEntityShadows = value,
                                "text.disable_entity.tooltip.disable_entity_shadows"));

                ConfigCategory entityCategory = builder
                                .getOrCreateCategory(Text.translatable("text.disable_entity.category.entities"));
                addDescription(entityCategory, entryBuilder, "text.disable_entity.section.entities.description");
                entityCategory.addEntry(
                                booleanEntry(entryBuilder,
                                                Text.translatable(
                ...
                entityCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.hide_players"),
                                config.entityRendering.hidePlayers, value -> config.entityRendering.hidePlayers = value,
                                "text.disable_entity.tooltip.hide_players"));
                entityCategory
                                .addEntry(booleanEntry(entryBuilder,
                                                Text.translatable("text.disable_entity.option.hide_hostile_mobs"),
                ...
                entityCategory
                                .addEntry(booleanEntry(entryBuilder,
                                                Text.translatable("text.disable_entity.option.hide_passive_mobs"),
                ...
                entityCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.hide_item_entities"),
                ...
                entityCategory
                                .addEntry(booleanEntry(entryBuilder,
                                                Text.translatable("text.disable_entity.option.hide_projectiles"),
                ...
                entityCategory
                                .addEntry(booleanEntry(entryBuilder,
                                                Text.translatable("text.disable_entity.option.hide_armor_stands"),
                ...
                entityCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.hide_experience_orbs"),
                ...
                entityCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.hide_item_frames"),
                ...
                entityCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.hide_leash_knots"),
                ...
                entityCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.hide_display_entities"),
                ...
                entityCategory
                                .addEntry(booleanEntry(entryBuilder,
                                                Text.translatable("text.disable_entity.option.hide_misc_entities"),
                                                config.entityRendering.hideMiscellaneousEntities,
                                                value -> config.entityRendering.hideMiscellaneousEntities = value,
                                                "text.disable_entity.tooltip.hide_misc_entities"));

                ConfigCategory nametagCategory = builder
                                .getOrCreateCategory(Text.translatable("text.disable_entity.category.nametags"));
                addDescription(nametagCategory, entryBuilder, "text.disable_entity.section.nametags.description");
                nametagCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.nametags_enabled"),
                                config.nametags.enabled,
                                value -> config.nametags.enabled = value,
                                "text.disable_entity.tooltip.nametags_enabled"));
                nametagCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.hide_player_nametags"),
                                config.nametags.hidePlayers,
                                value -> config.nametags.hidePlayers = value,
                                "text.disable_entity.tooltip.hide_player_nametags"));
                nametagCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.hide_mob_nametags"),
                ...
                nametagCategory.addEntry(
                                booleanEntry(entryBuilder,
                                                Text.translatable("text.disable_entity.option.hide_armor_stand_labels"),
                ...
                ConfigCategory particlesCategory = builder
                                .getOrCreateCategory(Text.translatable("text.disable_entity.category.particles"));
                addDescription(particlesCategory, entryBuilder, "text.disable_entity.section.particles.description");
                particlesCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.particles_enabled"),
                                config.particles.enabled,
                                value -> config.particles.enabled = value,
                                "text.disable_entity.tooltip.particles_enabled"));
                particlesCategory.addEntry(entryBuilder
                                .startEnumSelector(Text.translatable("text.disable_entity.option.particle_mode"),
                                                ParticleFilterMode.class, config.particles.mode)
                                .setDefaultValue(ParticleFilterMode.ALL)
                                .setSaveConsumer(value -> config.particles.mode = value)
                                .setTooltip(Text.translatable("text.disable_entity.tooltip.particle_mode"))
                                .build());
                particlesCategory.addEntry(booleanEntry(entryBuilder,
                ...
                particlesCategory
                                .addEntry(booleanEntry(entryBuilder,
                                                Text.translatable("text.disable_entity.option.particle_explosion"),
                ...
                particlesCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.particle_redstone"),
                ...
                particlesCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.particle_ambient"),
                ...
                ConfigCategory blockEntityCategory = builder
                                .getOrCreateCategory(Text.translatable("text.disable_entity.category.block_entities"));
                addDescription(blockEntityCategory, entryBuilder,
                                "text.disable_entity.section.block_entities.description");
                blockEntityCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.block_entities_enabled"),
                ...
                blockEntityCategory
                                .addEntry(booleanEntry(entryBuilder,
                                                Text.translatable("text.disable_entity.option.hide_shulker_boxes"),
                ...
                blockEntityCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.hide_enchanting_tables"),
                ...
                blockEntityCategory.addEntry(
                                booleanEntry(entryBuilder,
                                                ...
                                                value -> config.blockEntities.hideMiscellaneousBlockEntities = value,
                                                "text.disable_entity.tooltip.hide_misc_block_entities"));

                ConfigCategory blockStateCategory = builder
                                .getOrCreateCategory(Text.translatable("text.disable_entity.category.block_states"));
                addDescription(blockStateCategory, entryBuilder,
                                "text.disable_entity.section.block_states.description");
                blockStateCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.block_states_enabled"),
                ...
                blockStateCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.freeze_observers"),
                ...
                blockStateCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.freeze_repeaters_comparators"),
                ...
                blockStateCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.freeze_other_dynamic"),
                ...
                ConfigCategory worldRenderCategory = builder
                                .getOrCreateCategory(Text.translatable("text.disable_entity.category.world_rendering"));
                addDescription(worldRenderCategory, entryBuilder,
                                "text.disable_entity.section.world_rendering.description");
                worldRenderCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.world_rendering_enabled"),
                ...
                worldRenderCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.disable_vignette"),
                ...
                worldRenderCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.disable_hand_bob"),
                ...
                worldRenderCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.disable_overlays"),
                ...
                ConfigCategory distanceCategory = builder
                                .getOrCreateCategory(
                                                Text.translatable("text.disable_entity.category.distance_culling"));
                addDescription(distanceCategory, entryBuilder,
                ...
                distanceCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.entity_distance_limit_enabled"),
                                config.distanceCulling.entityDistanceLimitEnabled,
                                value -> config.distanceCulling.entityDistanceLimitEnabled = value,
                                "text.disable_entity.tooltip.entity_distance_limit_enabled"));
                distanceCategory.addEntry(entryBuilder
                                .startIntSlider(Text.translatable("text.disable_entity.option.entity_render_distance"),
                                ...
                                .setDefaultValue(DisableEntityConfig.DEFAULT_ENTITY_RENDER_DISTANCE)
                                .setSaveConsumer(value -> config.distanceCulling.entityRenderDistance = value)
                                .setTextGetter(value -> Text.translatable("text.disable_entity.value.blocks", value))
                                .setTooltip(Text.translatable("text.disable_entity.tooltip.entity_render_distance"))
                                .build());
                distanceCategory.addEntry(booleanEntry(entryBuilder,
                                Text.translatable("text.disable_entity.option.block_entity_distance_limit_enabled"),
                                config.distanceCulling.blockEntityDistanceLimitEnabled,
                                value -> config.distanceCulling.blockEntityDistanceLimitEnabled = value,
                                "text.disable_entity.tooltip.block_entity_distance_limit_enabled"));
                distanceCategory.addEntry(entryBuilder
                                .startIntSlider(Text.translatable(
                                ...
                                .setDefaultValue(DisableEntityConfig.DEFAULT_BLOCK_ENTITY_RENDER_DISTANCE)
                                .setSaveConsumer(value -> config.distanceCulling.blockEntityRenderDistance = value)
                                .setTextGetter(value -> Text.translatable("text.disable_entity.value.blocks", value))
                                .setTooltip(Text.translatable(
                                                "text.disable_entity.tooltip.block_entity_render_distance"))
                                .build());

                ConfigCategory hotkeyCategory = builder
                                .getOrCreateCategory(Text.translatable("text.disable_entity.category.hotkeys"));
                addDescription(hotkeyCategory, entryBuilder, "text.disable_entity.section.hotkeys.description");
                hotkeyCategory.addEntry(entryBuilder
                                .startTextDescription(Text.translatable("text.disable_entity.hotkeys.description"))
                                .build());

                ConfigCategory compatCategory = builder
                                .getOrCreateCategory(Text.translatable("text.disable_entity.category.compatibility"));
                addDescription(compatCategory, entryBuilder, "text.disable_entity.section.compatibility.description");
                compatCategory.addEntry(entryBuilder.startTextDescription(
                                Text.translatable(ModCompatibility.SODIUM_LOADED
                                                ? "text.disable_entity.compat.sodium.present"
                                                : "text.disable_entity.compat.sodium.absent"))
                                .build());
                compatCategory.addEntry(entryBuilder.startTextDescription(
                                Text.translatable(
                                                ModCompatibility.IRIS_LOADED ? "text.disable_entity.compat.iris.present"
                                                                : "text.disable_entity.compat.iris.absent"))
                                .build());
                compatCategory.addEntry(entryBuilder.startTextDescription(Text.translatable(
                                ...
                                .build());
                compatCategory.addEntry(entryBuilder.startTextDescription(
                                Text.translatable(ModCompatibility.LITHIUM_LOADED
                                                ? "text.disable_entity.compat.lithium.present"
                                                : "text.disable_entity.compat.lithium.absent"))
                                .build());
                compatCategory.addEntry(entryBuilder.startTextDescription(Text.translatable(
                                ModCompatibility.MORE_CULLING_LOADED ? "text.disable_entity.compat.more_culling.present"
                ...
                compatCategory.addEntry(entryBuilder.startTextDescription(Text.translatable(
                                ...
                                .build());
                compatCategory.addEntry(entryBuilder.startTextDescription(Text.translatable(
                                ModCompatibility.DYNAMIC_FPS_LOADED ? "text.disable_entity.compat.dynamic_fps.present"
                                                : "text.disable_entity.compat.dynamic_fps.absent"))
                                .build());
                compatCategory.addEntry(entryBuilder.startTextDescription(Text.translatable(
                                ModCompatibility.INDIUM_LOADED ? "text.disable_entity.compat.indium.present"
        ...
        private static void addDescription(ConfigCategory category, ConfigEntryBuilder entryBuilder,
                        String translationKey) {
                category.addEntry(entryBuilder.startTextDescription(Text.translatable(translationKey)).build());
        }
        ...
        private static Text buildFeatureSummary(DisableEntityConfig config) {
                ...
                return Text.literal("Preset: " + presetLabel(config.activePreset).getString()
                                + ". Active feature groups: " + activeFeatureGroups + "/8. Master switch: "
                                + (config.globalEnabled ? "on" : "off") + ".");
        }

        private static Text presetLabel(OptimizationPreset preset) {
                return switch (preset) {
                        case CUSTOM -> Text.translatable("text.disable_entity.preset.custom");
                        case BALANCED -> Text.translatable("text.disable_entity.preset.balanced");
                        case PERFORMANCE -> Text.translatable("text.disable_entity.preset.performance");
                        case AGGRESSIVE -> Text.translatable("text.disable_entity.preset.aggressive");
                };
        }

        private static me.shedaniel.clothconfig2.api.AbstractConfigListEntry<Boolean> booleanEntry(
                        ConfigEntryBuilder entryBuilder, Text title, boolean currentValue,
                        Consumer<Boolean> saveConsumer,
                        String tooltipKey) {
                return entryBuilder.startBooleanToggle(title, currentValue)
